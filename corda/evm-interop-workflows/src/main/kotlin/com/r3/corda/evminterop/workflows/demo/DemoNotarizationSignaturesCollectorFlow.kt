...
typealias DemoCollectNotarizationSignaturesFlow = NotarizationSignaturesCollectorFlow.CollectNotarizationSignaturesFlow
...
object NotarizationSignaturesCollectorFlow {
    ...
    class CollectNotarizationSignaturesFlowResponder(private val session: FlowSession) :
        FlowLogic<Unit>() {
    ...
    class CollectorInitiator(
        ...
        override fun call() {
            if (requestParams.transactionSignature.isValid(requestParams.transactionId)) {
                ...
                val signature = serviceHub.evmInterop().web3Provider()
                    .signData(requestParams.transactionId.bytes)
